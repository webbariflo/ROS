...
RUN chmod +x Tools/environment_install/install-prereqs-ubuntu.sh && \
    chown ardupilot:ardupilot Tools/environment_install/install-prereqs-ubuntu.sh

# Run the script
RUN sudo -u ardupilot bash -x Tools/environment_install/install-prereqs-ubuntu.sh -y
